...
if(isset($_SESSION['username'])) {
    ...
    // Redirect the user to the login page or handle the situation when the user is not logged in
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php echo $username; ?></div> <!-- Display the username -->
                  </div>
                  <div class="row">
