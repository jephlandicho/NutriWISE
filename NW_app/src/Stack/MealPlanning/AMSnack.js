...
const AMSnack = () => {
  ...
  const { AvegetablesAMSnacks, AfruitAMSnacks, AriceAAMSnacks, AriceBAMSnacks, AriceCAMSnacks, AMilkAMSnacks, ALFAMSnacks, AMFAMSnacks,AHFAMSnacks, AFatAMSnacks, ASugarAMSnacks,
    ...
    ANFMilkAMSnacks,setANFMilkAMSnacks,} = useContext(ResultContext);
  ...
  const sectionsWithVal = [
    ...
    { name: 'Whole Milk', value: AWholeMilkAMSnacks },
    { name: 'Low-Fat Milk', value: ALFMilkAMSnacks },
    { name: 'Non-Fat Milk', value: ANFMilkAMSnacks },
          ...
          data.forEach((item) => {
            ...
            switch (food_group) {
              ...
              case 'Rice C':
                ...
                break;
              case 'Whole Milk':
                setAWholeMilkAMSnacks(am_snacks);
                break;
              case 'Low-Fat Milk':
                setALFMilkAMSnacks(am_snacks);
                break
              case 'Non-Fat Milk':
                setANFMilkAMSnacks(am_snacks);
                break
              case 'LF Meat':
